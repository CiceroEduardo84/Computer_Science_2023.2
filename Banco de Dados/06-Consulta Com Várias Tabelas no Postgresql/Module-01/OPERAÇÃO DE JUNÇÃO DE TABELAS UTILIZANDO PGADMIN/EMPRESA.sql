...
SELECT E.ID, E.ULT_NOME, D.NOME, R.NOME
FROM EMPREGADO E	
	 INNER JOIN DEPARTAMENTO D ON D.ID = E.ID_DEPTO
	 INNER JOIN REGIAO R ON D.ID_REGIAO = R.ID_REGIAO;
	 
SELECT E.ID,E.ULT_NOME, C.NOME
FROM EMPREGADO E
	 INNER JOIN CLIENTE C ON E.ID = C.VENDEDOR;

SELECT E.ID,E.ULT_NOME, C.NOME
FROM EMPREGADO E
	 RIGHT JOIN CLIENTE C ON E.ID = C.VENDEDOR;
	 
SELECT E.ID,E.ULT_NOME, C.NOME
FROM EMPREGADO E
	 LEFT JOIN CLIENTE C ON E.ID = C.VENDEDOR;
	 
SELECT E.ID,E.ULT_NOME, C.NOME
FROM EMPREGADO E
	 FULL JOIN CLIENTE C ON E.ID = C.VENDEDOR;
	 
SELECT *
FROM DEPARTAMENTO
	 INNER JOIN REGIAO USING(ID_REGIAO);
	 
SELECT G.ID, G.ULT_NOME, G.CARGO, S.ID,S.ULT_NOME, S.CARGO
FROM EMPREGADO G
	 INNER JOIN EMPREGADO S ON S.ID_GERENTE = G.ID;